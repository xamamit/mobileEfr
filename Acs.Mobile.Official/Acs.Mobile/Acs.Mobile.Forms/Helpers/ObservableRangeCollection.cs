...
namespace Acs.Mobile.ESig.Helpers
{
    ...
    public class ObservableRangeCollection<T> : ObservableCollection<T>
    {
        ...
        /// <summary> 
        /// Initializes a new instance of the System.Collections.ObjectModel.ObservableCollection(Of T) 
